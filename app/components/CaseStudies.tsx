...
const caseStudies = [
  {
    ...
    technologies: ["AWS Organizations", "ECS Fargate", "Docker", "Terraform", "GitHub Actions", "PostgreSQL", "RDS", "Redis", "Django", "Celery", "GuardDuty", "CloudTrail"],
  },
  {
    ...
    technologies: ["ECS Fargate", "Docker", "GitHub Actions", "Blue-Green Deployments", "SQS", "SNS", "CloudFormation", "Python", "Bash"],
  },
  {
    ...
    technologies: ["Azure DevOps", "Kotlin", "Swift", "PowerShell", "Bash", "Jira", "Confluence", "Git"],
  },
  {
    ...
    technologies: ["AWS Control Tower", "Landing Zone Accelerator", "CodePipeline", "AWS Organizations", "IAM Identity Center", "Ansible", "Sumo Logic", "Linux"],
  },
  {
    ...
    technologies: ["CloudWatch", "PagerDuty", "New Relic", "Sumo Logic", "SNS", "Lambda", "Python", "Bash"],
  },
  {
    ...
    technologies: ["CloudFormation", "AWS CDK", "Systems Manager", "RDS", "DynamoDB", "SQS", "SNS", "PostgreSQL", "MySQL", "Python"],
  },
];
